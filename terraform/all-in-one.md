...
| <a name="input_ssh_options"></a> [ssh\_options](#input_ssh_options)                                                   | Additional options to pass to the SSH command used to connect to the target_host after installing NixOS.                                                                                                                                                  | `map(string)`                                                          | <pre>{<br> UserKnownHostsFile = "/dev/null"<br> StrictHostKeyChecking = "no"<br>}</pre> |    no    |
