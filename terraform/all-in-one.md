...
| <a name="input_use_target_as_builder"></a> [use\_target\_as\_builder](#input_use_target_as_builder)                   | Use target as builder. Boots kexec first so target has nix. With build\_on\_remote=true, builds directly on target preserving nix store. With build\_on\_remote=false, uses target as remote builder for local nix-build.                                 | `bool`                                                                    | `false`                                                                      |    no    |
