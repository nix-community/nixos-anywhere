...
| <a name="input_install_pass"></a> [install\_pass](#input_install_pass)                                                | Password used to connect to the target\_host during installation                                                                                                                                                                                          | `string`                                                                  | `null`                                                                       |    no    |
...
| <a name="input_install_sudo_pass"></a> [install\_sudo\_pass](#input_install_sudo_pass)                                | Sudo password for remote sudo operations during installation. Only supported with sudo, not doas.                                                                                                                                                         | `string`                                                                  | `null`                                                                       |    no    |
